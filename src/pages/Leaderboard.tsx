              ...
              {rows.map((r, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="w-[120px] h-[120px] rounded-full overflow-hidden bg-background/40 border border-white/10 shrink-0">
                      <CharacterAvatar seed={r.user_id} gender={r.gender ?? "male"} traits={r.traits} size={120} />
                    </div>
