    ...
    >
      <div className="relative pointer-events-auto" style={{ height: H }}>
        ...
        <motion.span
          aria-hidden
          initial={false}
          animate={{ x: indicatorX, opacity: active ? 1 : 0, scale: active ? 1 : 0.6 }}
          transition={spring}
          style={{ top: H / 2, left: 0 }}
        ...
        <motion.span
          ...
          transition={spring}
          className="absolute top-1.5 left-0 -translate-x-1/2 w-10 h-1 rounded-full bg-primary shadow-[0_0_14px_hsl(var(--primary))]"
        />
